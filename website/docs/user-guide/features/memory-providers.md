...
description: "External memory provider plugins — Honcho, OpenViking, Mem0, Hindsight, RetainDB, ByteRover, Supermemory"
---
...
```yaml
memory:
  provider: openviking   # or honcho, mem0, hindsight, retaindb, byterover, supermemory
```
